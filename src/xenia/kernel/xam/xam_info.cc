...
dword_result_t XamLoaderGetLaunchDataSize_entry(lpdword_t size_ptr) {
  ...
  const unsigned char ldata[1020] = {
      ...
      0x74, 0x69, 0x6E, 0x67, 0x73, 0x20, 0x31, 0x7C, 0x31, 0x7C, 0x32, 0x30,
      0x30, 0x7C, 0x31, 0x7C, 0x31, 0x7C, 0x32, 0x30, 0x31, 0x7C, 0x32, 0x30,
      0x30, 0x7C, 0x30, 0x38, 0x34, 0x7C, 0x31, 0x7C, 0x31, 0x7C, 0x31, 0x7C,
